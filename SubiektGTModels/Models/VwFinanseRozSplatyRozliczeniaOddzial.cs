...
public partial class VwFinanseRozSplatyRozliczeniaOddzial
{
    ...
    public string? NzsIdWaluty { get; set; }
    ...
    public string? NzsIdWalutyDlugu { get; set; }
    ...
    public string? IdWalutyRozRozliczanego { get; set; }

    public string? IdWalutyDokRozliczajacego { get; set; }

    public int? TypDlugu { get; set; }

    public int RozliczenieNaCentrali { get; set; }
}
