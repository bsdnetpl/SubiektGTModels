...
public partial class PojEksploatacja
{
    ...
    public virtual SlKategorium? PprIdKategoriiNavigation { get; set; }

    public virtual KhKontrahent? PprIdKhNavigation { get; set; }

    public virtual PojPojazd PprIdPojazduNavigation { get; set; } = null!;
}
