...
public partial class PrzOdliczenieDoliczenie
{
    ...
    public virtual SlRodzajOdliczenium? OdIdRodzajuOdliczeniaNavigation { get; set; }

    public virtual PdWspolnik OdIdWspolnikaNavigation { get; set; } = null!;
}
