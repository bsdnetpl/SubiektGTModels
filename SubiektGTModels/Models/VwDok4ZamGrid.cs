...
public partial class VwDok4ZamGrid
{
    ...
    public string? PowNrPelny { get; set; }

    public DateTime? PowDataWyst { get; set; }

    public decimal? ZreKwWartosc { get; set; }

    public int Statusreal { get; set; }

    public int Statusrez { get; set; }
    ...
    public bool SsPrzetworzonoZkwZd { get; set; }
    ...
    public DateTime? VenderoData2 { get; set; }

    public decimal? ZaliczkaZk { get; set; }
