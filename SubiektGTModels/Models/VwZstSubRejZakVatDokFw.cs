...
public partial class VwZstSubRejZakVatDokFw
{
    ...
    public string? DokDoDokNrPelny { get; set; }

    public DateTime? DokDoDokDataWyst { get; set; }

    public string? DokMscWyst { get; set; }
    ...
    public string? DokWystawil { get; set; }

    public string? DokOdebral { get; set; }
    ...
    public string? DokUwagi { get; set; }

    public int? DokKatId { get; set; }

    public string? DokTytul { get; set; }

    public string? DokPodtytul { get; set; }
    ...
    public DateTime? DataObowiazkuPodatkowego { get; set; }

    public bool? DokMechanizmPodzielonejPlatnosci { get; set; }

    public bool? DojWew { get; set; }
}
