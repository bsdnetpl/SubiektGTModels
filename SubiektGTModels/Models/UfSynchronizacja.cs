...
public partial class UfSynchronizacja
{
    ...
    public virtual ICollection<UfSynchroKodyKresk> UfSynchroKodyKresks { get; set; } = new List<UfSynchroKodyKresk>();

    public virtual UfZadanie? UsyIdZadanieNavigation { get; set; }
}
