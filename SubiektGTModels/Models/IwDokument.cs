...
public partial class IwDokument
{
    ...
    public virtual SlKategorium? IwKat { get; set; }

    public virtual SlMagazyn IwMag { get; set; } = null!;

    public virtual ICollection<IwPowiazanium> IwPowiazaniumIwaIdCzNavigations { get; set; } = new List<IwPowiazanium>();

    public virtual ICollection<IwPowiazanium> IwPowiazaniumIwaIdZbNavigations { get; set; } = new List<IwPowiazanium>();

    public virtual ICollection<IwPozycja> IwPozycjas { get; set; } = new List<IwPozycja>();

    public virtual DokDokument? IwPw { get; set; }

    public virtual DokDokument? IwRw { get; set; }
}
