...
public partial class VwDokZwroty
{
    ...
    public int? DokDoDokTyp { get; set; }

    public int? DokDoDokPodtyp { get; set; }

    public decimal? MDokWartNetto { get; set; }

    public decimal? MDokWartMag { get; set; }

    public decimal? MDokWartTwNetto { get; set; }

    public decimal? MDokWartTwBrutto { get; set; }

    public decimal? MDokWartBrutto { get; set; }
}
